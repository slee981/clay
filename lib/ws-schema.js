...
var schema = {
  ...
  "set_session_done":         { direction: "c2s", handler: "lib/project-sessions.js", description: "Toggle the done flag on a session (moves between Active and Completed tabs)" },
  ...
  "config_state":             { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Full config state: model, mode, effort, betas, thinking (live session)" },
  "config_defaults":          { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Persisted server/project defaults (effort, mode, model) for the Settings default bars" },
  ...
  "set_show_codex":           { direction: "c2s", handler: "lib/project-sessions.js", description: "Toggle the daemon-wide Show Codex flag (hides Codex new-session button when false)" },
  "set_show_codex_result":    { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Show Codex setting result" },
  "show_codex_changed":       { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Broadcast when Show Codex flag changes (any tab)" },
  ...
  "set_project_label":        { direction: "c2s", handler: "lib/project-sessions.js", description: "Set or clear a project label (overrides the icon-strip abbreviation)" },
  "set_project_label_result": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Set label result" },
