...
// --- DOM refs ---
  ...
  createStore({
    ...
    // e.g. "claude-opus-4-8[1m]". Carried on the model_info payload; "" when the
    // vendor asserts no default (e.g. Codex). Used to resolve "(default)" labels.
    sdkDefaultModel: "",
    currentMode: "default",
    currentEffort: "medium",
    // Persisted server/project defaults (from the config_defaults carrier),
    // distinct from the live currentEffort/currentMode/currentModel above.
    // null until the carrier arrives; the Settings default bars bind to these.
    serverDefaultEffort: null,
    projectDefaultEffort: null,
    serverDefaultMode: null,
    projectDefaultMode: null,
